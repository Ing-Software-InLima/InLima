...
export default function MenuPage() {
    ...
    const handleClick = (asunto) => {
        router.push(`/asunto/${encodeURIComponent(asunto)}`);
    };
    ...
    return (
        <>
            ...
            <div className="flex" style={{ marginTop: '80px', marginLeft: '90.11px' }}>
                <button onClick={() => handleClick('Veredas_rotas')} className="relative" style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                ...
                <button onClick={() => handleClick('Calles_contaminadas')} className="relative " style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Poste_de_luces_apagadas')} className="relative " style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Construcción_sin_licencia')} className="relative " style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Comercio_ilegal')} className="relative " style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Invasión_no_autorizada_de_lugares_públicos')} className="relative " style={{ height: '170px', width: '123.95px' }}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
            ...
            <div className="flex" style={{ marginTop: '100px', marginLeft: '90.11px' }}>
                <button onClick={() => handleClick('Árboles_obstruyen_la_circulación')} className="relative " style={{ height: '170px', width: '123.95px',  marginRight: '90px'}}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Vehiculo_abandonado')} className="relative " style={{ height: '170px', width: '123.95px',  marginRight: '90px'}}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Mascota_perdida')} className="relative " style={{ height: '170px', width: '123.95px',  marginRight: '90px'}}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Inmueble_abandonado')} className="relative " style={{ height: '170px', width: '123.95px',  marginRight: '90px'}}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button onClick={() => handleClick('Propiedad_en_mal_estado')} className="relative " style={{ height: '170px', width: '123.95px',  marginRight: '90px'}}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
                ...
                <button  onClick={() => handleClick('Otros')} className="relative " style={{ height: '170px', width: '123.95px'}}>
                    <img src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" style={{ height: '123.95px', width: '123.95px' }} />
