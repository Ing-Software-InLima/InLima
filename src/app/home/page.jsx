...
export default function MenuPage() {
    ...
    return (
        <Layout>
            ...
            <Image src="/divider.svg" alt="divider" width={500} height={10} className="mt-3"/>
            ...
            <div className="flex" style={{ marginTop: '80px', marginLeft: '90.11px' }}>
                <Link href="/complaint/[type]" as="/complaint/Veredas_rotas">
                    <div className="relative" style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                        <Image src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" width={123.95} height={123.95} />
                        <Image src="/veredaRota.svg" alt="VeredaRota" className="inset-0" width={100} height={79.02} style={{ position: 'relative', left: '50%', top: '50%', transform: 'translate(-50%, -50%)' }} />
                ...
                <Link href="/complaint/[type]" as="/complaint/Construcción_sin_licencia">
                    <div className="relative" style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                        <Image src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" width={123.95} height={123.95}  />
                        <Image src="/construcSLicencia.svg" alt="construcSLicencia" className="inset-0" height={79.02} width = {75} style={{ position: 'relative', left: '50%', top: '45%', transform: 'translate(-50%, -50%)' }} />
            ...
            <div className="flex" style={{ marginTop: '100px', marginLeft: '90.11px' }}>
                <Link href="/complaint/[type]" as="/complaint/Árboles_obstruyen_la_circulación">
                    <div className="relative" style={{ height: '170px', width: '123.95px', marginRight: '90px' }}>
                        <Image src="/circulo.svg" alt="Circulo" className="absolute inset-0 w-full h-full" width={123.95} height={123.95}  />
                        <Image src="/arbolesOCircula.svg" alt="arbolesOCircula" className="inset-0" height={79.02} width={80} style={{ position: 'relative', left: '50%', top: '45%', transform: 'translate(-50%, -50%)' }} />
